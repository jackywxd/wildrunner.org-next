    ...
    <Context.Provider value={value}>
      ...
      {started && (
        ...
        <button
          ...
          data-music-control=""
          className="fixed bottom-4 right-4 z-40 inline-flex h-11 w-11 items-center justify-center border border-foreground bg-background text-foreground shadow-md transition-colors hover:bg-secondary print:hidden"
