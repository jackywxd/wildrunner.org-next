/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4b118ef6ad3eb61f5a5e23ace6b14bec)
// Runtime types generated with workerd@1.20260714.1 2026-07-27 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* wildrunner-org-next-staging */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		MEMBER_STORAGE_QUOTA_MB: "10240";
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* wildrunner-org-next-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_FROM_ADDRESS" | "RESEND_FROM_NAME" | "MEMBER_STORAGE_QUOTA_MB" | "NEXTJS_ENV">> {}
}
